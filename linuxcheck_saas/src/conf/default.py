...
# 蓝鲸智云开发者中心的域名，形如：http://openpaas.cw.com
...
# 默认logo
IMG_FILE = os.path.join(PROJECT_ROOT, 'static/img/logo.png')
# ==============================================================================
# Templates
# ==============================================================================
# mako template dir
...
CHECKS_ITEM_JSON_FILE = os.path.join(PROJECT_ROOT, 'fixtures/initial_check_item_data.json')
REPORTS_TEMPLATE_JSON_FILE = os.path.join(PROJECT_ROOT, 'fixtures/initial_reports_template_data.json')
ITEM_TEMPLATE_JSON_FILE = os.path.join(PROJECT_ROOT, 'fixtures/initial_item_template_data.json')
SCRIPT_CONTENT_JSON_FILE = os.path.join(PROJECT_ROOT, 'fixtures/initial_script_content_data.json')
ITEM_MENU_JSON_FILE = os.path.join(PROJECT_ROOT, 'fixtures/initial_item_menu_data.json')
CONFIG_ITEM_JSON_FILE = os.path.join(PROJECT_ROOT, 'fixtures/initial_config_item_data.json')
SCRIPTS_CHECK_FILE = os.path.join(PROJECT_ROOT, 'fixtures/initial_scripts_check_data')
SCRIPTS_CHECK_CONFIG_INFO_FILE = os.path.join(PROJECT_ROOT, 'fixtures/initial_scripts_configinfo_data')
SCRIPTS_PERFORMS_FILE = os.path.join(PROJECT_ROOT, 'fixtures/initial_scripts_performs_data')
SCRIPTS_SERVER_INFO_FILE = os.path.join(PROJECT_ROOT, 'fixtures/initial_scripts_serversinfo_data')
MODULE_ITEM_VALUE_FILE = os.path.join(PROJECT_ROOT, 'fixtures/initial_module_item_value_data.json')
SCRIPTS_SUSE_CHECK_FILE = os.path.join(PROJECT_ROOT, 'fixtures/initial_suse_check_data')
SCRIPTS_SUSE_PERFORMS_FILE = os.path.join(PROJECT_ROOT, 'fixtures/initial_suse_performs_data')
