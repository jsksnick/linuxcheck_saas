...
(function (window, $) {
    ...
    var ngStyleProvider = function ($scope, grid) {
        ...
        $scope.viewportStyle = function () {
            ...
            // return { "width": grid.rootDim.outerWidth + "px","height":"auto"};
        };
                ...
                return {
                    pre: function ($scope, iElement, iAttrs) {
                        ...
                        return grid.init().then(function () {
                            ...
                            // options.$gridServices.DomUtilityService.RebuildGrid(
                            //     options.$gridScope,
                            //     options.ngGrid
                            // );  //add by landon 20141119(解决文字重叠问题)
    ...
    window.ngGrid.i18n['en'] = {
        ...
        ngGroupPanelDescription: '请将列名拖到这片区域，这样就能看到分组视图。',
    ...
    angular.module('ngGrid').run(['$templateCache', function ($templateCache) {
        ...
        $templateCache.put('footerTemplate.html',
          ...
          "\n" +
          "    <div class=\"ngTotalSelectContainer  grid_footer\">\r" +
          "\n" +
          ...
          "        </div>\r" +
          "\n" +
          "        <div class=\"ngFooterSelectedItems\" ng-hide=\"true\">\r" +
          "\n" +
          ...
          "\n" +
          "            <button type=\"button\" class=\"ngPagerButton\" ng-click=\"pageToFirst()\" ng-disabled=\"cantPageBackward()\" title=\"{{i18n.ngPagerFirstTitle}}\"><span class=\"fa fa-lg fa-step-backward\"></span></button>\r" +
          "\n" +
          "            <button type=\"button\" style='font-size: 12px;' class=\"ngPagerButton\" ng-click=\"pageBackward()\" ng-disabled=\"cantPageBackward()\" title=\"{{i18n.ngPagerPrevTitle}}\"><span class=\"fa fa-lg fa-caret-left\"></span></button>\r" +
          "\n" +
          ...
          "\n" +
          "            <button type=\"button\" style='font-size: 12px;' class=\"ngPagerButton\" ng-click=\"pageForward()\" ng-disabled=\"cantPageForward()\" title=\"{{i18n.ngPagerNextTitle}}\"><span class=\"fa fa-lg fa-caret-right\"></span></button>\r" +
          "\n" +
          "            <button type=\"button\" class=\"ngPagerButton\" ng-click=\"pageToLast()\" ng-disabled=\"cantPageToLast()\" title=\"{{i18n.ngPagerLastTitle}}\"><span class=\"fa fa-lg fa-step-forward\"></span></button>\r" +
          "\n" +
          "        </div>\r" +
          "\n" +
          "    </div>\r" +
